...
game_state.main.prototype = {
    ...
    create: function() { 
        ...
        this.score = 0;
        var style = { font: "30px Comic Sans MS", fill: "#ffffff" };
    ...
    update: function() {
        ...
        if (this.bird.inWorld == false)
            this.restart_game(); 
        this.bird.body.gravity.y=this.bird.body.y*0.8+600;
    ...
    add_row_of_pipes: function() {
        ...
        for (var i = 0; i < 8; i++)
            if (i != hole && i != hole +1) 
                if(i!= hole-1||(i==hole-1&&Math.random()<0.6))this.add_one_pipe(400, i*60+10);   
